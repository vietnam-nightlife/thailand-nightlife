  ...
  <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
    ...
    <div className="mb-10 text-center">
      ...
      <p className="mt-4 text-sm leading-7 text-zinc-400">
        실제 이용요금은 룸, 이용시간, 주류 및 기타 조건에 따라
        달라질 수 있습니다.
      </p>
    </div>
    ...
    {/* =================================================
        ROOM PRICE
    ================================================= */}
    <div className="mb-12 rounded-3xl border border-amber-500/30 bg-zinc-950/80 p-6 sm:p-8">
      ...
      <div className="text-center">
        <p className="text-sm text-zinc-400">
          Small 룸부터 VIP Big Room까지
        </p>

        <p className="mt-4 text-3xl font-black text-amber-400 sm:text-4xl">
          500B ~ 2,000B
        </p>

        <p className="mt-3 text-xs text-zinc-500">
          룸 크기 및 이용 조건에 따라 요금이 달라질 수 있습니다.
        </p>
      </div>
    </div>
    ...
    <div className="mb-12">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        {/* SOJU */}
        <div className="rounded-2xl border border-amber-500/30 bg-zinc-950 p-6 text-center">
    ...
    {/* =================================================
        PREMIUM WHISKY
    ================================================= */}
    <div className="mb-12 rounded-3xl border border-amber-500/40 bg-zinc-950 p-6 text-center sm:p-10">
      ...
      <p className="mt-5 text-3xl font-black text-amber-400 sm:text-4xl">
        9,750B
      </p>
    ...
    {/* =================================================
        LADY CHARGE
    ================================================= */}
    <div className="mb-12 rounded-3xl border border-red-500/30 bg-zinc-950 p-6 text-center sm:p-10">
