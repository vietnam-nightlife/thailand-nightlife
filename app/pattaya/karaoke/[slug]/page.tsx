...
const PEGASUS_SLUG = "pattaya-pegasus-karaoke";

const businesses = {
  [MONALISA_SLUG]: {
    name: "파타야 모나리자 가라오케",
    englishName: "Pattaya Mona Lisa Karaoke",
    shortName: "모나리자",
    ...
    about: [
      "파타야 모나리자 가라오케는 파타야에서 한국식 KTV를 찾는 여행객들에게 알려진 가라오케 업소입니다.",
      "일행끼리 프라이빗하게 이용할 수 있는 룸 형태의 공간에서 노래와 함께 주류와 음식을 즐기는 방식으로 이용할 수 있습니다.",
      "방문 인원과 룸 종류, 이용시간에 따라 실제 이용조건이 달라질 수 있으므로 예약 전에 가격과 포함사항을 확인하는 것을 권장합니다.",
    ],
    location: "Pattaya City, Chon Buri 20150",
    locationSub: "Pattaya · Na Kluea 일대",
    pickup: true,
  },
  ...
  [PEGASUS_SLUG]: {
    ...
    hours: "방문 전 확인",
    description:
      "파타야 페가수스 가라오케의 외관, 로비, 룸과 시설 및 이용정보를 한곳에서 확인할 수 있습니다. 방문 전 최신 영업정보와 이용조건을 확인하세요.",
    about: [
      "파타야 페가수스 가라오케는 파타야에서 이용할 수 있는 대형 가라오케 공간입니다.",
      "외관부터 로비와 프라이빗 룸까지 다양한 공간으로 구성되어 있으며, 일행끼리 편하게 이용할 수 있는 형태의 가라오케입니다.",
      "룸 종류와 인원, 이용시간 및 주문내용에 따라 실제 이용조건과 금액이 달라질 수 있으므로 방문 전에 최신 정보를 확인하는 것을 권장합니다.",
    ],
    location: "Pattaya City, Chon Buri",
    locationSub: "파타야 지역",
    pickup: false,
  },
};
...
export async function generateMetadata({
  ...
  return {
    title: `${business.name} | ${business.englishName}`,
...
function BreadcrumbJsonLd({
  ...
  business: (typeof businesses)[BusinessSlug];
  slug: string;
}) {
  const jsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: "가라오케",
        item: "https://www.thailandnightlifetravel.com/pattaya/karaoke",
      },
      {
        "@type": "ListItem",
        position: 4,
        name: business.name,
        item: `https://www.thailandnightlifetravel.com/pattaya/karaoke/${slug}`,
      },
    ],
  };
...
function BusinessJsonLd({
  ...
  const jsonLd = {
    ...
    openingHours:
      business.hours !== "방문 전 확인" ? "Mo-Su 18:00-00:00" : undefined,
  };
...
export default async function PattayaKaraokePage({
  ...
  const isPegasus = slug === PEGASUS_SLUG;

  return (
    <main className="min-h-screen overflow-x-hidden bg-[#08080a] text-white">
      <BreadcrumbJsonLd business={business} slug={slug} />
    ...
    <div className="mt-3 flex flex-wrap gap-1.5 sm:mt-3 sm:gap-2">
      ...
      <section className="container py-12 md:py-16">
        ...
        <h2 className="mt-3 text-3xl font-black md:text-4xl">
          {business.shortName} 가라오케 사진
        </h2>

        <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-500">
          외관부터 로비, 룸까지 실제 준비된 사진을 한곳에서 확인해보세요.
        </p>
      ...
      <section className="container py-12 md:py-16">
        <div className="text-center">
          ...
          <h2 className="mt-3 text-3xl font-black md:text-4xl">
            {business.shortName} 가라오케 가격 안내
          </h2>

          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-zinc-500">
            룸 종류와 인원, 이용시간 및 주문내용에 따라 실제 금액이 달라질 수
            있습니다.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2">
          <div className="rounded-3xl border border-cyan-400/30 bg-[#111114] p-7">
            ...
            <h3 className="mt-3 text-2xl font-black">일반 룸</h3>

            <div className="mt-7 border-t border-white/10">
              <div className="flex justify-between border-b border-white/10 py-5">
                <span className="text-zinc-400">기본 이용</span>
                <strong className="text-cyan-300">가격 문의</strong>
              </div>

              <div className="flex justify-between py-5">
                <span className="text-zinc-400">인원별 이용</span>
                <strong className="text-cyan-300">가격 문의</strong>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-amber-400/30 bg-[#111114] p-7">
            ...
            <h3 className="mt-3 text-2xl font-black">VIP 룸</h3>

            <div className="mt-7 border-t border-white/10">
              <div className="flex justify-between border-b border-white/10 py-5">
                <span className="text-zinc-400">기본 이용</span>
                <strong className="text-amber-300">가격 문의</strong>
              </div>
          ...
          <div className="rounded-3xl border border-fuchsia-400/30 bg-[#111114] p-7">
            ...
            <h3 className="mt-3 text-2xl font-black">주류 & 음식</h3>

            <div className="mt-7 border-t border-white/10">
              <div className="flex justify-between border-b border-white/10 py-5">
                <span className="text-zinc-400">주류</span>
                <strong className="text-fuchsia-300">가격 문의</strong>
              </div>

              <div className="flex justify-between py-5">
                <span className="text-zinc-400">음식</span>
                <strong className="text-fuchsia-300">가격 문의</strong>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-pink-400/30 bg-[#111114] p-7">
            ...
            <h3 className="mt-3 text-2xl font-black">픽업 서비스</h3>

            <div className="mt-7 border-t border-white/10">
              <div className="flex justify-between py-5">
                <span className="text-zinc-400">픽업 가능 여부</span>
                <strong className="text-pink-300">
                  {business.pickup ? "예약 시 확인" : "문의"}
                </strong>
              </div>
            </div>
          </div>
        ...
        <p className="mt-7 text-center text-xs text-zinc-600">
          ※ 가격 및 이용조건은 변경될 수 있으므로 방문 전 최신 정보를
          확인해주세요.
        </p>
      </section>
      ...
      <section className="container py-12">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-2 font-black">한국식 KTV · 가라오케</p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            <p className="text-xs text-zinc-500">위치</p>
            <p className="mt-2 font-black">파타야</p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            <p className="text-xs text-zinc-500">영업시간</p>
            <p className="mt-2 font-black">{business.hours}</p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            <p className="text-xs text-zinc-500">Google</p>
            <p className="mt-2 font-black">
              ★ {business.rating} · 리뷰 {business.reviews}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container py-12 md:py-16">
        <p className="text-xs font-black tracking-[0.35em] text-red-500">
          ABOUT {isPegasus ? "PEGASUS" : "MONA LISA"}
        </p>
      ...
      <section className="container py-12">
        <div className="rounded-3xl border border-white/10 bg-[#111114] p-7 md:p-10">
          ...
          <h2 className="mt-3 text-3xl font-black">
            {business.shortName} 가라오케 위치
          </h2>

          <p className="mt-6 max-w-3xl text-sm leading-8 text-zinc-400">
            파타야 지역에 위치한 {business.name}입니다. 방문 전 지도에서 최신
            위치를 확인하는 것을 권장합니다.
          </p>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-[#111114] p-7 md:p-10">
            ...
            <p className="mt-5 text-sm leading-7 text-zinc-500">
              방문 전 당일 영업 여부를 다시 확인하는 것을 권장합니다.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-[#111114] p-7 md:p-10">
            ...
            <p className="mt-5 text-sm leading-7 text-zinc-500">
              저녁이나 주말에는 원하는 룸을 이용하기 위해 미리 예약하는 것을
              권장합니다.
            </p>
          </div>
        </div>
      ...
      <section className="container py-12 md:py-16">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-[#111114] p-7">
            ...
            <h3 className="mt-4 text-xl font-black">노래방 시설</h3>

            <p className="mt-3 text-sm leading-7 text-zinc-500">
              한국식 KTV 형태로 노래와 음악을 즐길 수 있습니다.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-[#111114] p-7">
            ...
            <h3 className="mt-4 text-xl font-black">픽업</h3>

            <p className="mt-3 text-sm leading-7 text-zinc-500">
              픽업 서비스는 방문 전 가능 여부와 조건을 확인해주세요.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container py-12">
        <div className="rounded-3xl border border-white/10 bg-[#111114] p-7 md:p-10">
          ...
          <div className="mt-8 space-y-5 text-sm leading-8 text-zinc-400">
            <p>
              파타야 시내에서는 Grab 또는 Bolt를 이용하면 편리하게 이동할 수
              있습니다.
            </p>

            <p>
              차량 호출 시 "{business.englishName}"을 검색하고 목적지를
              확인하세요.
            </p>

            <p>
              픽업을 이용하는 경우 예약 시 숙소 위치를 전달하고 픽업 가능
              여부를 확인하는 것이 좋습니다.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 space-y-4">
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            <summary className="cursor-pointer font-black">
              {business.shortName} 가라오케 영업시간은?
            </summary>

            <p className="mt-4 text-sm leading-7 text-zinc-500">
              현재 안내되는 영업시간은 {business.hours}입니다. 방문 전 당일
              영업 여부를 확인하세요.
            </p>
          </details>
          ...
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-500">
              룸 종류와 인원, 이용시간 및 주문내용에 따라 달라질 수 있으므로
              예약 전 최신 가격을 확인하세요.
            </p>
          </details>
          ...
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-500">
              저녁이나 주말에는 원하는 룸을 이용하기 위해 미리 예약하는 것을
              권장합니다. 예약 없이 방문 시에는 자리가 없거나 오래 기다리셔야
              할 수 있습니다.
            </p>
          </details>
          ...
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-500">
              픽업 서비스는 업체의 당일 운영 여부와 조건을 확인한 후
              이용해주세요.
            </p>
          </details>
        </div>
      ...
      <section className="container py-14 md:py-20">
        <div className="rounded-3xl border border-red-500/20 bg-gradient-to-b from-red-950/20 to-[#111114] p-8 text-center md:p-14">
          <p className="text-xs font-black tracking-[0.35em] text-red-500">
            {business.englishName.toUpperCase()}
          </p>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-zinc-400">
            {business.name}의 위치와 시설, 룸 사진 및 이용정보를
            확인해보세요.
          </p>
